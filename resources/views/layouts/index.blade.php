...
<header class="am-topbar am-topbar-fixed-top wos-header">
    <div class="am-container">
        <h1 class="am-topbar-brand">
            <a href="#"><img src="{{asset('MengUI/images/logo.png')}}" alt=""></a>
        </h1>
...
<div class="banner">
    <div class="am-g am-container">
        ...
        <div class="am-u-sm-0 am-u-md-0 am-u-lg-4 padding-none">
            <div class="star am-container"><span><img src="{{asset('MengUI/images/star.png')}}">荣誉榜</span></div>
...
<footer>
  ...
  am-avg-md-2 am-avg-lg-2 am-gallery-overlay" data-am-gallery="{ pureview: true }" >
            <li class="w2">
                <div class="am-gallery-item">
                    <a href="{{asset('MengUI/Temp-images/dd.jpg')}}">
                        <img src="{{asset('MengUI/Temp-images/dd.jpg')}}" />
